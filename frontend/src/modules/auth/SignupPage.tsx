        ...
        <div className="surface w-full max-w-[400px] p-8 flex flex-col gap-6 bg-[var(--surface)] shadow-md">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs text-[var(--ink-dim)]">
              Create an account for clinical decision assistance.
            </p>
          </div>
          ...
          >
            <div className="flex flex-col gap-1.5">
              <label className="text-mono text-xs text-[var(--ink-dim)] font-mono">Full Name & Credentials</label>
              <input
                type="text"
                required
                value={fullName}
                onChange={(e) => setFullName(e.target.value)}
                placeholder="Dr. Sunita Sharma, MD"
                className="text-sm bg-[var(--void)] text-[var(--ink)] placeholder-[var(--ink-faint)]"
              />
            </div>

            <div className="flex flex-col gap-1.5">
              <label className="text-mono text-xs text-[var(--ink-dim)] font-mono">Work Email</label>
              <input
                type="email"
                required
                value={email}
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-mono text-xs text-[var(--ink-dim)] font-mono">Password</label>
              <input
                type="password"
                required
                value={password}
          ...
          <div className="text-mono text-[11px] text-[var(--ink-faint)] text-center hairline-t pt-4 font-mono">
            By signing up, you acknowledge the medical notice guidelines.
          </div>
        </div>
      </main>
    </div>
